...
(0, _data.ELEMENT).FORM.addEventListener("submit", formHandler);
function formHandler(e) {
    e.preventDefault();
    try {
        if (!(0, _data.ELEMENT).INPUT.value) throw new InputError((0, _data.ERROR).NO_DATE);
        toLocaleStorage((0, _data.ELEMENT).INPUT.value);
        render((0, _data.ELEMENT).TARGET_DATE);
    } catch (err) {
        alert(err.message);
        console.log(err);
    }
...
function toLocaleStorage(date) {
    ...
    (0, _data.ELEMENT).TARGET_DATE = new Date(JSON.parse(localStorage.getItem("date")));
    (0, _data.ELEMENT).TARGET_DATE.setHours(0);
}
function render(date) {
    if ((0, _dateFns.isPast)(date) || (0, _dateFns.isEqual)(date, new Date())) (0, _data.ELEMENT).DESCRIPTION_FIELD.textContent = (0, _data.DESCRIPTION).PAST;
    else (0, _data.ELEMENT).DESCRIPTION_FIELD.textContent = (0, _data.DESCRIPTION).FUTURE;
    (0, _data.ELEMENT).TIMER_FIELD.textContent = defineTimer(date);
}
function defineTimer(date) {
    const result = (0, _dateFns.formatDistanceToNowStrict)(date, {
        unit: "day",
        locale: (0, _ruDefault.default)
    });
    ...
    if (date === new Date()) return (0, _dateFns.formatDistanceToNow)(date, {
        locale: (0, _ruDefault.default)
    });
    else if (!duration.years && !duration.months) return (0, _dateFns.formatDuration)(duration, {
        format: [
            "days",
            "hours",
            "minutes"
        ...
        if (date.getFullYear() > new Date().getFullYear()) yearsInInterval = (0, _dateFns.eachYearOfInterval)({
            start: new Date(),
            end: date
        });
        else yearsInInterval = (0, _dateFns.eachYearOfInterval)({
            start: date,
            end: new Date()
        });
        if (yearsInInterval.length > 0) yearsInInterval.forEach((item)=>{
            if ((0, _dateFns.isLeapYear)(new Date(item))) counter++;
        });
        const years = (0, _dateFns.formatDuration)(duration, {
            format: [
                "years"
            ],
            locale: (0, _ruDefault.default)
        });
        const hours = (0, _dateFns.formatDuration)(duration, {
            format: [
                "hours"
            ],
            locale: (0, _ruDefault.default)
        ...
        let days = "";
        if (daysPreCount.slice(-2) >= 10 && daysPreCount.slice(-2) <= 20) days = `${daysPreCount} ${(0, _data.APPENDIX).OTHERDAYS}`;
        else if (daysPreCount.at(-1) == 1) days = `${daysPreCount} ${(0, _data.APPENDIX).ONEDAY}`;
        else if (daysPreCount.at(-1) > 1 && daysPreCount.at(-1) < 5) days = `${daysPreCount} ${(0, _data.APPENDIX).TWOTOFOURDAYS}`;
        else days = `${daysPreCount} ${(0, _data.APPENDIX).OTHERDAYS}`;
        let output = "";
        if (parseInt(days) == 0) output = years + " " + hours;
        else output = years + " " + days + " " + hours;
        return output;
    }
}

},{"date-fns":"9yHCA","./js/data":"3d49z","date-fns/locale/ru":"d1Q8X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
...
},{"../toDate/index.js":"fsust","../differenceInCalendarYears/index.js":"f4WIY","../compareAsc/index.js":"h01l4","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"97N8I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lPnhm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../compareAsc/index.js":"h01l4","../add/index.js":"h7zb2","../differenceInDays/index.js":"1mpAo","../differenceInHours/index.js":"9Vac7","../differenceInMinutes/index.js":"4Qv17","../differenceInMonths/index.js":"8lj6Z","../differenceInSeconds/index.js":"5uZgU","../differenceInYears/index.js":"2tncr","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8JhlH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3d49z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ELEMENT", ()=>ELEMENT);
parcelHelpers.export(exports, "DESCRIPTION", ()=>DESCRIPTION);
parcelHelpers.export(exports, "ERROR", ()=>ERROR);
parcelHelpers.export(exports, "APPENDIX", ()=>APPENDIX);
const ELEMENT = {
...
},{"../../../_lib/buildMatchFn/index.js":"2nEf9","../../../_lib/buildMatchPatternFn/index.js":"4GjCS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequire0ef7")
